...
import { Tube, Bend, Crane } from "./tubes";
    ...
    return (
        ...
        >
            <filter id="drop-shadow" x="-50%" y="-50%" width="200%" height="200%">
                <feDropShadow dx="3" dy="3" stdDeviation="3" floodColor="black" flood-opacity="0.5" />
            </filter>
            <filter id="inner-shadow" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur in="SourceAlpha" stdDeviation="4" result="blur" />
                <feOffset dx="0" dy="0" result="offset" />
                <feComposite in="offset" in2="SourceAlpha" operator="out" result="inverse" />
                <feFlood floodColor="black" flood-opacity="0.5" result="shadowColor" />
